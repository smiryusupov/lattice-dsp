Release notes for the 1.2 line
==============================

This page summarizes the current validated ``lattice-dsp`` 1.2 feature line.
...
The 1.2 line emphasizes a rare combination for a Python DSP package: stable SISO
...
which are outside the 1.2 public scope.
...
The 1.2 line has a coherent baseline ladder:
...
The public 1.2 scope is the validated baseline ladder above.  Larger MIMO runtime studies, stronger noisy/non-rational SISO AAK/Nehari validations, operator-level SISO solvers, and matrix AAK/Nehari solvers are outside this release scope and are documented separately from the supported finite-section APIs.
