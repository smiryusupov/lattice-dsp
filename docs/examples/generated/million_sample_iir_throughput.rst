...
.. code-block:: text
   ...
   IIR median time: 0.006037 s
   IIR throughput: 165.64 million samples/s
   
   FIR truncation taps: 131,072
   FFT length for FIR reference: 2,097,152
   FFT/FIR median time: 0.087522 s
   IIR speedup over FFT/FIR reference: 14.50x
...
* :download:`million_sample_iir_throughput.csv <_artifacts/million_sample_iir_throughput/million_sample_iir_throughput.csv>`
